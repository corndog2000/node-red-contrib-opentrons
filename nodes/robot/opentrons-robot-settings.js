...
module.exports = function(RED) {
    function OpentronsRobotSettingsNode(config) {
        ...
        node.on('input', async function(msg, send, done) {
            ...
            try {
                ...
                const response = await axios.get('/settings/robot', {
                    baseURL: baseURL,
                    headers: headers
                });
    ...
    RED.nodes.registerType("opentrons-robot-settings", OpentronsRobotSettingsNode);
}